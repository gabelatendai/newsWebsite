                ...
                <ul class="side-menu">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li>
                                <a href="comments.php" class="slide-item">News Comments</a>
                            </li>
                        </ul>
                    </li>
                    <li class="slide">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-edit"></i><span class="side-menu__label">NewsLetter</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu">
                            <li>
                                <a href="newsletters.php" class="slide-item">News Letters</a>
                            </li>
                        </ul>
                    </li>
<!--                    <li class="slide">-->
...
<!--                    </li>-->
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-file-text"></i><span class="side-menu__label">Feedback</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu">
                            <li>
                                <a href="feedback.php" class="slide-item">FeedBack</a>
                            </li>
                        </ul>
                    </li>
<!--                    <li class="slide">-->
...
<!--                    </li>-->
                    ...
                    <li>
                        <a class="side-menu__item" href="#"><i class="side-menu__icon fa fa-question-circle"></i>
