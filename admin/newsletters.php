								...
								<div class="col-md-12">
									<div class="card shadow">
										<div class="card-header">
                                            ...
                                            <a class="btn btn-primary" href="#" style="color: #FFF; float: right"
                                            >Send News</a>
                                            </p>
										</div>
												...
												<table id="example" class="table table-striped table-bordered w-100 text-nowrap">
													<thead>
														<tr>
															...
															<th class="wd-15p">Enail</th>
															<th class="wd-25p">Delete</th>
														</tr>
													</thead>
                                                    <tbody>
                                                    <?php
                                                    $sliders = R::findAll('newsletter');
...
//                                                          $cat = R::findOne('categories', 'id=?', [$cat_id]);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Remove
<!--                                                                <a class="pull-right" href="#delete--><?php //echo $id; ?><!--"-->
<!--                                                                   data-toggle="modal"-->
