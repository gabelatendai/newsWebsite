...
$sliders = R::findOne('categories','id=?',[$id]);
				...
				<div class="news">
					<div class="news-grids">
						<div class="col-md-8 news-grid-left">
							<h3>latest <?php echo $sliders->title; ?> news</h3>
                            <ul>
                                <?php

                                $sliders = R::findAll('news','category=?',[$id]);
                                $count = R::count('news','category=?',[$id]);
                                    ...
                                    foreach ($sliders as $slider) {
                                        ...
                                        <li>
                                            ...
                                            <div class="news-grid-right1">
                                                <h4>
                                                    <a href="single.php<?php echo '?id=' . $slug; ?>"><?php echo $slider->title ?></a>
                                                </h4>
                                                <h5>By <a href="#">Admin</a> <label>|</label>
                                                    <i><?php echo $slider->date ?></i></h5>
                                                <p><?php
